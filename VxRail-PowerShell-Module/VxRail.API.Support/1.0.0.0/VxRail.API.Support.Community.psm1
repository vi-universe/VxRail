...
<#
.Synopsis
Retrieves the VxRail community home URL
...
.Notes
You can run this cmdlet to retrieves the VxRail community home URL
...
.Parameter Count
The number of messages the user wants to query. Default is 3.

.Notes 
You can run this cmdlet to retrieves VxRail community messages
